...
def generate_font_image(text, font_path=None, image_size=(1200, 180)):
...
def predict_top_fonts(embedding, average_embeddings, top_n=10):
    distances = []
...
def predict_font_from_image(image):
    ...
    top_fonts = predict_top_fonts(embedding, test_average_embeddings, top_n=10)

    font_data = []
    for font_name, font_distance in top_fonts:
